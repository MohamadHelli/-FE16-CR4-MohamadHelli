    ...
    for (let info of arr) {
        ...
        <div class="col-lg-3 col-md-5 col-sm-10 col-xs-12">
            ...
            <div class="card-body">
                ...
                <hr>
                <p class="card-text"> 
                <i class="fa-solid fa-triangle-exclamation"></i> Priority level: <a class="btn-level btn btn-success btn-sm"><span class="result">${info.level}</span></a></p>
...
function likeAction() {
    let btns = document.getElementsByClassName("btn-level");
